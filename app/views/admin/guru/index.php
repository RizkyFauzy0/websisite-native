...
<?php endif; ?>
<div class="flex justify-between items-center mb-6"><div><h1 class="text-3xl font-bold text-gray-800">Data Guru</h1></div>
...
<form action="<?= BASE_URL ?>/admin/guru/store" method="POST" enctype="multipart/form-data"><div class="p-4">
<p class="text-gray-600">Form Data Guru - Silakan isi data yang diperlukan</p></div>
